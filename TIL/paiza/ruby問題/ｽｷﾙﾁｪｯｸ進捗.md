...
4月2日から数えるのに 4月1日を基準にしている?

通過日数、、、日付を数字に変換してソートするとよい？
4月2日から数えるときは、12/31までの日数を計算しておくとよい？

途中
```
days = [31,28,31,30,31,30,31,31,30,31,30,31]
n = gets.to_i
paiza = gets.split.map(&:to_i)
p_day = paiza[1]
if paiza[0] != 1
    (paiza[0]-1).times do |i|
        p_day += days[i]
    end
    p_day2 = (365-92+p_day)%365
end
menbers = []
n.times do
    menbers << gets.split.map(&:to_i)
